...
def _mock_weasyprint():
    ...
    if "weasyprint" not in sys.modules:
        ...
        for _name in [
            "weasyprint.text", "weasyprint.text.ffi", "weasyprint.css",
            "weasyprint.css.computed_values", "weasyprint.css.counters",
...
@pytest.fixture()
async def order_with_receiving(client, auth_headers_and_user, warehouse_headers, db_session, unique_inn, mock_notification):
