...
@celery_app.task(bind=True, name="app.tasks.document_tasks.convert_rtf_to_docx")
...
@celery_app.task(bind=True, name="app.tasks.document_tasks.convert_docx_to_pdf")
