...
- **Склад** (доступ при роли warehouse/admin): `/warehouse/receiving`, `/warehouse/packing`, `/warehouse/fbo`, `/warehouse/print`, `/warehouse/scanner`, `/warehouse/shipping`
...
- **Склад:** Приёмка, Упаковка, FBO, Печать, Сканер.
...
| /warehouse/fbo | FBOPage | FBO-поставки WB/Ozon: список, создание, синхронизация, этикетки, импорт ШК |
